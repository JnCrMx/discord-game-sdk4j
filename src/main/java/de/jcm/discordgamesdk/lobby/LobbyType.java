...
{
	/**
	 * A private lobby which cannot be found by a {@link LobbyManager#search(LobbySearchQuery)}.
	...
	PRIVATE,
	/**
	 * A public Lobby which can be found by a {@link LobbyManager#search(LobbySearchQuery)}.
